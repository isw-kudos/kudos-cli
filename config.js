...
module.exports = {
  ...
  start: {
    ...
    all: `concurrently -p name -n CORE,APP,WEB,USER,PROV,NOTF,LIC,SSHT -c white.bgRed,white.bgBlue,white.bgYellow,white.bgGreen,white.bgMagenta,black.bgCyan,black.bgWhite,brown.bgYellow --kill-others "${START}" "${START} app" "${START} web" "${START} user" "${START} provider" "${START} notification" "${START} licence" "${START} screenshot" --color always`,
